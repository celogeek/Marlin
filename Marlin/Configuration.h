...
#define STRING_CONFIG_H_AUTHOR "(Celogeek, 2.0.x)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 136.27
  #define  DEFAULT_bedKi 18.48
  #define  DEFAULT_bedKd 251.16
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION (65 + X_PROBE_OFFSET_FROM_EXTRUDER) // 65 - 45
  #define RIGHT_PROBE_BED_POSITION (310 + X_PROBE_OFFSET_FROM_EXTRUDER) // 310 - 45
  #define FRONT_PROBE_BED_POSITION (30 + Y_PROBE_OFFSET_FROM_EXTRUDER) // 30 - 12
  #define BACK_PROBE_BED_POSITION (290 + Y_PROBE_OFFSET_FROM_EXTRUDER) // 290 - 12
